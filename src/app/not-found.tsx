      ...
      <div className="nf__core">
        <div className="nf__mark">
          ...
          <span className="nf__ornament" aria-hidden="true">
            ...
            >
              <path
                d="M80 8 L88 30 L112 30 L94 46 L101 68 L80 54 L59 68 L66 46 L48 30 L72 30 Z"
                stroke="#B8963E"
                strokeWidth="0.8"
                fill="none"
                opacity="0.55"
        ...
        <p className="nf__desc">
          Украшение, которое вы ищете, могло быть продано или переехать.
          Загляните в каталог — там есть другие редкие вещи.
        </p>
