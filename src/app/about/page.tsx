  ...
  return (
    <main className="about">
      ...
      <section className="about__intro">
        ...
        <img className="about__watermark" src="/logo-monogram.png" alt="" aria-hidden="true" />
        <div className="about__intro-inner">
          <Breadcrumbs crumbs={[{ label: "Главная", href: "/" }, { label: "О бренде" }]} />
          ...
          <p className="about__lead">
            Natali Borei — это авторская мастерская украшений ручной работы. Каждое изделие
            создаётся в единственном экземпляре, по зёрнышку, в технике художественной вышивки
            бисером.
          </p>
        </div>
      </section>
      ...
      <section className="about__row reveal">
        ...
        <div className="about__text">
          ...
          <p className="about__p">
            Мы не делаем тираж. Брошь, кулон, манжета — каждая вещь проживает свою собственную
            историю от первого эскиза до последнего узелка. Это медленное, вдумчивое ремесло, в
            котором нет двух одинаковых результатов.
          </p>
          <p className="about__p">
            Украшение становится продолжением того, кто его носит — его настроения, силы, тишины.
          </p>
        </div>
      </section>
      ...
      <section className="about__row about__row--reverse reveal">
        <div className="about__photo reveal" data-tilt="" data-depth="1.3">
          <div className="about__photo-inner" data-tilt-img="">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/photos/shining-river.jpg" alt="Процесс работы с бисером" />
          </div>
        ...
        <div className="about__text">
          ...
          <p className="about__p">
            Японский бисер Miyuki и TOHO, чешские кристаллы, натуральный янтарь, пресноводный
            жемчуг, коралл и природные камни. Основа — кожа и шёлк. Ничего случайного.
          </p>
      ...
      <section className="about__feature reveal" data-tilt="" data-depth="0.6">
        ...
        <div className="about__feature-cap">
          <p className="about__feature-text">
            <em>
              «Я создаю украшения, которые хочется рассматривать в деталях — живые, объёмные, со
              своей энергией.»
            </em>
          </p>
      ...
      <section className="about__process">
        <header className="about__process-head">
          ...
          <h2 className="about__h2"><em>От эскиза до узелка</em></h2>
        </header>
        <div className="about__steps">
          <div className="step">
            ...
            <p className="step__d">
              Идея рождается из камня, цвета или фактуры. Каждая работа начинается с рисунка от
              руки.
            </p>
          </div>
          <div className="step">
            ...
            <p className="step__d">
              Бисер укладывается вручную, зерно за зерном, слой за слоем — десятки часов кропотливой
              работы.
            </p>
          </div>
          <div className="step">
            ...
            <p className="step__d">
              Обработка края, кожаная основа, фурнитура. Украшение становится завершённым объектом.
            </p>
          </div>
        </div>
