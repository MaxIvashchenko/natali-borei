        ...
        <article className="legal__doc is-active">
          <section className="legal__section" id="section-1">
            ...
            <p className="legal__p">
              Natali Borei уважает конфиденциальность каждого клиента. Настоящая
              политика описывает, какие данные мы собираем, как используем и
          ...
          <section className="legal__section" id="section-2">
            ...
            <ul className="legal__list">
              ...
              <li>
                Платёжные данные — обрабатываются платёжным провайдером; мы не
                храним данные карт.
              </li>
            </ul>
          </section>
          ...
          <section className="legal__section" id="section-4">
            ...
            <p className="legal__p">
              ...
              случаев, необходимых для выполнения заказа — служба доставки,
              платёжный провайдер.
            </p>
          </section>
          ...
          <section className="legal__section" id="section-5">
            ...
            <p className="legal__p">
              Сайт использует cookies для корректной работы корзины, сохранения
              языка и аналитики. Вы можете отключить cookies в настройках
              браузера.
            </p>
          </section>
          ...
          <section className="legal__section" id="section-6">
            ...
            <p className="legal__p">
              ...
              заказа и соблюдения законодательства.
            </p>
          </section>
          ...
          <section className="legal__section" id="section-7">
            ...
            <p className="legal__p">
              Вы вправе запросить доступ, исправление или удаление ваших
              персональных данных. Запросы принимаются на email.
            </p>
          </section>
          ...
          <div className="legal__doc-end">
            ...
            <div className="legal__contact">
              ...
              <p className="legal__contact-p">
                Напишите нам — ответим на всё о конфиденциальности и обработке
                данных.
              </p>
