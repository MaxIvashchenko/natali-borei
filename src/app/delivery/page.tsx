...
export const metadata: Metadata = {
  ...
  description:
    "Как заказать украшение Natali Borei, оплата, доставка по миру и возврат.",
};
    ...
    <main className="page">
      <header className="page__head page__head--with-hero">
        ...
        <h1 className="page__title">
          <em>Заказ и доставка</em>
        </h1>
        <hr className="gold-line gold-line--wide" />
        <p className="page__lead">
          Каждое украшение — ручная работа в единственном экземпляре. Ниже — как
          оформить заказ, оплатить и получить вашу вещь в любой точке мира.
        </p>
        ...
        <div className="order-steps">
          <div className="ostep reveal">
            ...
            <p className="ostep__d">
              Найдите вещь в каталоге или напишите нам — поможем подобрать и
              расскажем о наличии.
            </p>
          </div>
          <div className="ostep reveal">
            ...
            <p className="ostep__d">
              Согласуем детали, размер и способ доставки. Для индивидуального
              заказа обсудим эскиз и сроки.
            </p>
          </div>
          <div className="ostep reveal">
            ...
            <p className="ostep__d">
              После оплаты украшение бережно упаковывается и отправляется с
              трек-номером.
            </p>
          </div>
        </div>
        ...
        <div className="info-grid">
          <article className="info-card reveal">
            ...
            <p className="info-card__d">
              Отправляем в любую страну курьерскими службами. Сроки: 2–5 дней по
              стране, 7–18 дней — международно. Каждой посылке присваивается
              трек-номер.
            </p>
          </article>
          <article className="info-card reveal">
            ...
            <p className="info-card__d">
              Банковский перевод, карта или электронные платежи. Для
              международных заказов — удобный для вас способ. Цена каждого
              украшения — по запросу.
            </p>
          </article>
          <article className="info-card reveal">
            <span className="info-card__ic" aria-hidden="true">
            ...
            <p className="info-card__d">
              Авторская подарочная упаковка с фирменной коробкой и инструкцией
              по уходу. Готово для подарка.
            </p>
          </article>
          <article className="info-card reveal">
            <span className="info-card__ic" aria-hidden="true">
            ...
            <p className="info-card__d">
              Так как изделия создаются вручную в единственном экземпляре,
              возврат обсуждается индивидуально. При повреждении при доставке —
              заменяем или ремонтируем.
            </p>
          </article>
        </div>
      </section>
      ...
      <section className="page__cta reveal">
        ...
        <p className="page__cta-sub">
          Напишите нам — ответим на всё о заказе, доставке и индивидуальной
          работе.
        </p>
