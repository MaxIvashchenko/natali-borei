    ...
    <main className="page">
      <header className="page__head">
        ...
        <h1 className="page__title">
          <em>Материалы и уход</em>
        </h1>
        <hr className="gold-line gold-line--wide" />
        <p className="page__lead">
          Каждое украшение — это сотни часов кропотливой работы и материалы,
          отобранные вручную. Расскажем, из чего создаются вещи Natali Borei и
          как сохранить их красоту на долгие годы.
        </p>
      </header>
        ...
        <div className="mat-grid">
          <article className="mat-card reveal">
            ...
            <p className="mat-card__d">
              Miyuki и Toho — эталон калибровки и стойкости цвета. Каждая бусина
              одинакового размера, что даёт идеальную геометрию плетения.
            </p>
          </article>
          ...
          <article className="mat-card reveal">
            ...
            <p className="mat-card__d">
              Preciosa и премиальный огранённый кристалл — глубина блеска,
              чистая преломляющая способность, многолетняя стойкость покрытия.
            </p>
          </article>
          ...
          <article className="mat-card reveal">
            ...
            <p className="mat-card__d">
              Янтарь, коралл, агат, оникс, лунный камень, жемчуг. Подбираем
              каждый камень индивидуально — за характер рисунка и цвета.
            </p>
          </article>
          ...
          <article className="mat-card reveal">
            ...
            <p className="mat-card__d">
              Латунная основа с гальваническим покрытием золотом или серебром,
              гипоаллергенные сплавы. Замки, штифты, базы — европейское
              качество.
            </p>
          </article>
          ...
          <article className="mat-card reveal">
            ...
            <p className="mat-card__d">
              Нейлоновые мононити с памятью формы и натуральный шёлк. Каждый
              узел укрепляется вручную — украшение держит форму годами.
            </p>
          </article>
          ...
          <article className="mat-card reveal">
            ...
            <p className="mat-card__d">
              Итальянская кожа растительного дубления для оснований браслетов и
              манжет. Мягкая текстура, благородное старение, без ПВХ.
            </p>
          </article>
        </div>
      </section>
            ...
            {[
              {
                n: "01",
                t: "Храните отдельно",
                d: "Тканевый мешочек или фирменная коробка — украшения не должны касаться друг друга, чтобы избежать царапин на бусинах и кристаллах.",
              },
              {
                n: "02",
                t: "Надевайте последним",
                d: "Сначала макияж, парфюм и причёска — потом украшение. Так металл и нити не контактируют с косметикой и спиртом.",
              },
              {
                n: "03",
                t: "Берегите от воды",
                d: "Душ, бассейн, море, сауна — снимайте. Влага со временем тускнит покрытие фурнитуры и ослабляет натуральные нити.",
              },
              {
                n: "04",
                t: "Чистите мягкой тканью",
                d: "Сухая микрофибра или мягкая фланель. Никаких чистящих средств, ультразвука и паровых ванночек — они разрушают плетение.",
              },
              {
                n: "05",
                t: "Снимайте на ночь",
                d: "И во время спорта, сна, уборки. Резкие нагрузки и пот деформируют форму и ускоряют износ нитей.",
              },
            ].map(({ n, t, d }) => (
      ...
      <section className="page__section">
        ...
        <div className="dodont">
          <div className="dodont__col dodont--yes reveal">
            ...
            <ul>
              <li>
                Хранить в мешочке или фирменной коробке отдельно от других
                украшений.
              </li>
              <li>Протирать сухой мягкой тканью после носки.</li>
              <li>Носить регулярно — украшение «живёт» от прикосновений.</li>
              <li>
                Обращаться к нам за консультацией по уходу или мелкому ремонту.
              </li>
            </ul>
          </div>
          <div className="dodont__col dodont--no reveal">
            ...
            <ul>
              <li>
                Контактировать с водой, парфюмом, лаком для волос, кремами.
              </li>
              <li>Чистить ультразвуком, паром или агрессивной химией.</li>
              <li>
                Тянуть, перекручивать, спать в украшении — нити растягиваются.
              </li>
              <li>
                Оставлять под прямым солнцем — цвет бисера со временем выгорает.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="repair">
          <div className="repair__text reveal">
            ...
            <p className="repair__d">
              Любое украшение Natali Borei можно вернуть в мастерскую для
              бережного ремонта или переосновы — заменим замок, восстановим
              нить, освежим покрытие. Это часть нашей работы, и мы всегда на
              связи с теми, у кого наши вещи.
            </p>
            <p className="repair__d">
              При бережном уходе украшение служит десятилетиями и со временем
              обретает характер — кожа становится мягче, металл — тише в блеске,
              камни — глубже.
            </p>
          </div>
          <div className="repair__photo reveal" data-tilt="" data-depth="1">
      ...
      <section className="page__cta reveal">
        ...
        <p className="page__cta-sub">
          Расскажем, как обращаться с конкретным украшением, поможем с ремонтом
          или подберём подходящую вещь под ваш образ жизни.
        </p>
