...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    window.location.href =
      `mailto:boreinatali@gmail.com?subject=${encodeURIComponent(subject || "Запрос")}` +
    ...
    <main className="page">
      <header className="page__head">
        ...
        <h1 className="page__title">
          <em>Давайте познакомимся</em>
        </h1>
        <hr className="gold-line gold-line--wide" />
        <p className="page__lead">
          Напишите нам по поводу заказа готового украшения, индивидуальной
          работы или сотрудничества. Мы отвечаем лично и с удовольствием.
        </p>
      </header>
        ...
        <div className="contact__details">
          ...
          <div className="contact__block">
            ...
            <p className="contact__text">
              Пн–Сб · 10:00–19:00. Отвечаем обычно в течение дня.
            </p>
          </div>
          <hr className="divider-line" />
          <div className="contact__block">
            ...
            <p className="contact__text">
              Создаём украшения по вашей идее — от эскиза до готовой вещи.
              Расскажите, что вы представляете.
            </p>
          </div>
        </div>
