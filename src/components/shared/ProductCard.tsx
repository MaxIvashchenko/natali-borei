...
export default function ProductCard({ product: p }: Props) {
  ...
  return (
    <div className="prod-card" data-slug={p.id}>
      <Link className="prod-card__link" href={`/product/${p.id}`} aria-label={p.name}>
        <div className="prod-card__media">
          ...
          <div className="card-actions">
            ...
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill={faved ? "currentColor" : "none"} stroke="currentColor" strokeWidth="1.4">
